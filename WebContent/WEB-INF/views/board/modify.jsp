	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="card shadow">
				<div class="card-body">
					<!-- form action을 board/read로 보내는 이유는 수정완료하면 board/read로 가기 때문에 -->
					<form action="${root }board/read" method="get">	<!-- 컨트롤러에 GetMapping하기 때문에 method get을 사용 -->
						...
						<div class="form-group">
							<div class="text-right">
								...
								<a href="${root }board/read" class="btn btn-info">취소</a>	<!-- 취소 누르면 form 전송안하고 그냥 링크로 이동 -->
							</div>
						</div>
					</form>
				</div>
